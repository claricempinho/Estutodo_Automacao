...
public class CRPagar {
	...
	public void contasReceberPagar() {
        ...
        //INFORMANDO QUE O TÍTULO FOI PAGO
        
        
        //Informando que o título foi pago clicando no switch Recebido
        driver.findElement(By.xpath("//*[@id='custom-fields']/div/div[2]/div[2]/div/div[2]/div/div/div/div[1]")).click();
          
        //Verificando se a div principal de recebimento e form.pagamento foi inserida na pagina e se esta disponível para interação
        ...
        //Eperando o filho ul Conta de Crédito ser carregada e clicavel na pagina
        ...
        //Informando Acréscimo e Desconto
